...
public class МonitoringWriterTask  implements Runnable
{
     // public МonitoringWriterTask() { super(); }
    ...
    private   String name;
    public static final Logger monitorWriter_Log = LoggerFactory.getLogger(ru.hermes.msgbus.monitoring.МonitoringWriterTask.class);
