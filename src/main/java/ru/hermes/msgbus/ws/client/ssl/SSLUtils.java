package ru.hermes.msgbus.ws.client.ssl;
...
public class SSLUtils {
    ...
    public static SSLSocketFactory getMergedSocketFactory(ru.hermes.msgbus.ws.client.core.Security securityOne, Security securityTwo) throws GeneralSecurityException {
