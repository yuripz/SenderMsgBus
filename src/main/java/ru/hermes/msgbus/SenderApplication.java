...
public class SenderApplication implements CommandLineRunner {
    ...
    public void run(String... strings) throws Exception {
        ...
        //ApplicationContext MntrContext = new AnnotationConfigApplicationContext(MonitoringConfig.class );
        ...
        if ( Target_Connection == null)
        {
            ...
            MQbroker.stop();
            isNotifyOk = ru.hermes.msgbus.telegramm.NotifyByChannel.Telegram_sendMessage( "*Shutdown* Sender Application on " + InetAddress.getLocalHost().getHostAddress() + " , *нет связи с БД*", AppThead_log );
            System.exit(-22);
        }
