...
public class TheadDataAccess {
    ...
    private final String UPDATE_QUEUE_InfoStreamId="update " + dbSchema + ".MESSAGE_QUEUE q set msg_infostreamid = ? where q.ROWID = ?";
    private PreparedStatement stmt_UPDATE_QUEUE_InfoStreamId;
    private final String UPDATE_QUEUElog_Response="update " + dbSchema + ".MESSAGE_QUEUElog L set l.Resp_DT = current_timestamp, l.Response = ? where l.QUEUE_ID= ? and l.ROWID = ?";
    ...
    //public final String INSERT_QUEUElog_Request="{call insert into " + dbSchema + ".MESSAGE_QUEUElog L ( Queue_Id, Req_dt, request ) values( ?, current_timestamp, ?) returning ROWID into ? }";
    // public CallableStatement stmt_INSERT_QUEUElog;
    public PreparedStatement stmt_DELETE_Message_Details;
    public final String DELETE_Message_Details= "delete from " + dbSchema + ".MESSAGE_QueueDET D where D.queue_id =?";

    public PreparedStatement stmt_DELETE_Message_Confirmation;
    public final String DELETE_Message_Confirmation= "delete from " + dbSchema + ".MESSAGE_QUEUEDET d where d.queue_id = ?  and d.tag_par_num >=" +
    ...
    public final String DELETE_Message_ConfirmationH= "delete from " + dbSchema + ".MESSAGE_QUEUEDET d where d.queue_id = ?  and d.tag_id='Confirmation'";
    ...
    public final String INSERT_Message_Details= "INSERT into " + dbSchema + ".MESSAGE_QueueDET (QUEUE_ID, TAG_ID, TAG_VALUE, TAG_NUM, TAG_PAR_NUM) " +
                                                                                "values (?, ?, ?, ?, ?)";
